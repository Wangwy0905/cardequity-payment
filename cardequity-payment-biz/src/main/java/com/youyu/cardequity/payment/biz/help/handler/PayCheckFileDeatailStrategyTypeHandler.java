...
@MappedTypes({PayCheckFileDeatailStrategy.class})
public class PayCheckFileDeatailStrategyTypeHandler extends BaseString2StatusStrategyTypeHandler {

    @Override
    public String getClassSimpleName() {
        return PayCheckFileDeatailStrategy.class.getSimpleName();
    }
}
