...
@MappedTypes({PayTradeRefundStrategy.class})
public class PayTradeRefundStrategyTypeHandler extends BaseString2StatusStrategyTypeHandler {

    @Override
    public String getClassSimpleName() {
        return PayTradeRefundStrategy.class.getSimpleName();
    }
}
