...
@MappedTypes({PayTradeRefundFactory.class})
public class PayTradeRefundFactoryTypeHandler extends BaseString2StatusStrategyTypeHandler {

    @Override
    public String getClassSimpleName() {
        return PayTradeRefundFactory.class.getSimpleName();
    }
}
