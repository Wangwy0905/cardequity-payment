...
@MappedTypes({PayTradeRefundStatus.class})
public class PayTradeRefundStatusTypeHandler extends BaseString2StatusStrategyTypeHandler {

    @Override
    public String getClassSimpleName() {
        return PayTradeRefundStatus.class.getSimpleName();
    }
}
